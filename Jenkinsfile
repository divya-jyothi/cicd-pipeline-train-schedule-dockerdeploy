pipeline {
    ...
    stages {
        ...
        stage('Build Docker Image') {
            ...
            steps {
                script {
                    app = docker.build("ncodeitdocker/train-schedule1")
                    app.inside {
        ...
        stage('DeployToProduction') {
            ...
            steps {
                ...
                milestone(1)
                withCredentials([usernamePassword(credentialsId: 'webserver_login', usernameVariable: 'user', passwordVariable: 'divya123')]) {
                    script {
